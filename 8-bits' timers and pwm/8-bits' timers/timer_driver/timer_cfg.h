...
#define TIMER_0_PRESCALER    TIMER_PRESCALER_1
#define TIMER_2_PRESCALER    TIMER_PRESCALER_1

/* CPU_CLOCK_1M , CPU_CLOCK_4M , CPU_CLOCK_8M */
#define TIMER_0_CPU_CLOCK_REFERENCE			(CPU_CLOCK_1M)


/* TIMER_MODE_NORMAL , TIMER_MODE_CTC , TIMER_MODE_FAST_PWM , TIMER_MODE_PHASE_CORRECT_PWM */
#define TIMER_0_MODE		(TIMER_MODE_CTC)

/* TIMER_MODE_NORMAL , TIMER_MODE_CTC  , TIMER_MODE_FAST_PWM , TIMER_MODE_PHASE_CORRECT_PWM */
#define TIMER_2_MODE		(TIMER_MODE_FAST_PWM)
...
#define TIMER_0_OC0_MODE		(TIMER_OCn_NON_PWM_DISCONNECT)
#define TIMER_2_OC2_MODE		(TIMER_OCn_FAST_PWM_SET_AT_TOP)
